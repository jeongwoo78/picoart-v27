// PicoArt v28.6 - 일본어 금지 극강 강화 + Guidance 12
// Ultra-strong Japanese prohibition: 한국+중국 전통화 일본어 완전 차단
      ...
      'https://api.replicate.com/v1/models/black-forest-labs/flux-depth-dev/predictions',
      {
        ...
        body: JSON.stringify({
          input: {
            ...
            guidance: 12,                   // 프롬프트 엄격 적용 (일본어 금지 강화)
            output_format: 'jpg',
            output_quality: 90
          }
        })
