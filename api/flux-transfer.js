// PicoArt v28.7 - 프롬프트 간소화 + 속도 최적화
// Optimized prompts + guidance 11 + steps 24

// 동양화 DB
const chineseArtworks = [
  {id:'chinese_01',title:'천리강산도',artist:'왕희맹',subjects:['mountains','rivers','nature'],colors:['blue','green','gold'],mood:'majestic',style:'blue-green landscape',prompt:'Chinese blue-green landscape painting Qinglu Shanshui style by Wang Ximeng, grand panoramic mountains and rivers, brilliant blue-green mineral pigments, golden aged paper, meticulous gongbi technique, imperial court quality, majestic serene atmosphere, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana (ひらがな/カタカナ), PURE CHINESE'},
  {id:'chinese_02',title:'궁녀도',artist:'주방',subjects:['people','women','portraits'],colors:['soft pastels','earth tones'],mood:'elegant',style:'figure painting',prompt:'Chinese gongbi court painting style, elegant graceful figures preserving original subject gender and features, delicate fine facial features, flowing robes, soft harmonious colors, extremely detailed brushwork, refined imperial court quality, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana (ひらがな/カタカナ), PURE CHINESE'},
  {id:'chinese_03',title:'새우',artist:'제백석',subjects:['animals','aquatic life'],colors:['black ink','grey'],mood:'lively',style:'ink wash',prompt:'Chinese ink wash painting Shuimohua style by Qi Baishi, spontaneous expressive brushwork, lively movement, monochrome black ink gradations, minimalist composition with elegant empty space, modern Chinese literati painting quality, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana (ひらがな/カタカナ), PURE CHINESE'},
  {id:'chinese_09',title:'미인도',artist:'당인',subjects:['women','portraits','beauty'],colors:['soft colors','pastels'],mood:'refined',style:'beauty portrait',prompt:'Chinese gongbi beauty portrait style, elegant refined figure preserving original subject features, delicate detailed facial features, soft harmonious colors, fine silk texture rendering, graceful posture, traditional Chinese beauty painting quality, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana (ひらがな/カタカナ), PURE CHINESE'},
  {id:'chinese_11',title:'대나무',artist:'정섭',subjects:['bamboo','plants'],colors:['black ink','grey'],mood:'strong',style:'ink bamboo',prompt:'Chinese ink bamboo painting style by Zheng Xie, bold expressive brushstrokes, monochrome black ink, bamboo stalks and leaves, literati scholarly painting, symbolic of integrity and resilience, classical quality, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana (ひらがな/カタカナ), PURE CHINESE'},
  {id:'chinese_13',title:'새',artist:'황전',subjects:['birds','flowers','nature'],colors:['natural colors'],mood:'delicate',style:'bird and flower',prompt:'Chinese gongbi bird and flower painting style, detailed naturalistic bird feathers, precise meticulous brushwork, delicate soft colors, traditional flower-bird painting Huaniao, decorative elegant composition, imperial quality, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana (ひらがな/カタカナ), PURE CHINESE'},
  {id:'chinese_15',title:'말',artist:'서비홍',subjects:['horses','animals','movement'],colors:['black ink'],mood:'powerful',style:'ink horse',prompt:'Chinese ink wash horse painting style by Xu Beihong, dynamic powerful movement, bold expressive brushstrokes, monochrome black ink, modern Chinese painting style, energetic composition, contemporary ink painting quality, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana (ひらがな/カタカナ), PURE CHINESE'}
];

const koreanArtworks = [
  {id:'korean_01',title:'미인도',artist:'신윤복',subjects:['women','beauty','portraits'],colors:['soft pastels'],mood:'elegant',style:'beauty portrait',prompt:'Korean Hyewon Shin Yunbok Joseon Pungsokdo genre painting, elegant Korean woman in hanbok, soft pastel colors, gentle expression on hanji, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  ...
  {id:'korean_03',title:'단오풍정',artist:'신윤복',subjects:['festival','people','celebration'],colors:['vibrant colors'],mood:'joyful',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok Joseon Pungsokdo genre painting, Dano festival with Korean women in colorful hanbok, vibrant festive atmosphere, Korean daily life storytelling, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
...
const fallbackPrompts = {
  ...
  chinese_ink: {
    name: '중국 수묵화',
    prompt: 'Chinese ink wash painting Shuimohua style, monochrome black ink gradations, soft flowing brushstrokes, minimalist composition with elegant empty space, serene meditative atmosphere, authentic Chinese literati painting quality, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana, PURE CHINESE'
  },
  
  chinese_gongbi: {
    name: '중국 공필화',
    prompt: 'Chinese gongbi meticulous painting style, extremely fine detailed brushwork, delicate precise lines, rich mineral pigments, brilliant colors, birds and flowers subjects, ornate decorative patterns, authentic Chinese imperial court gongbi quality, ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana, PURE CHINESE'
  },
...
- FORBIDDEN: Japanese kana (ひらがな/カタカナ), Japanese text format
...
Return ONLY valid JSON (no markdown):
{
  ...
  "prompt": "Complete FLUX prompt starting with 'Chinese [style name] style, [characteristics]... ALLOWED: Chinese (漢字/汉字) text only, NO Japanese kana (ひらがな/カタカナ), PURE CHINESE'"
}
