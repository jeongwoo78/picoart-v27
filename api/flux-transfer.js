...
const koreanArtworks = [
  ...
  {id:'korean_05',title:'모란도',artist:'민화',subjects:['peony','birds','flowers'],colors:['rich vibrant colors'],mood:'prosperous',style:'folk flower',prompt:'Korean folk peony painting (Minhwa) style, rich vibrant peony flowers, decorative birds, bold colors, flat ornate composition, prosperity symbolism, traditional Korean folk art masterpiece quality, Chinese characters allowed, NOT Chinese style, NOT Japanese style, NO Japanese kana'},
