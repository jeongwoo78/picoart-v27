...
const koreanArtworks = [
  ...
  {id:'korean_02',title:'까치호랑이',artist:'민화',subjects:['tiger','magpie','animals'],colors:['bright colors','bold outlines'],mood:'cheerful',style:'folk painting',prompt:'Korean folk painting (Minhwa) style, bold black outlines, vibrant bright colors from five Korean colors (Obangsaek: red blue yellow white black), humorous cheerful tiger and magpie, flat decorative composition, naive playful folk aesthetic, traditional Korean minhwa masterpiece'},
  ...
  {id:'korean_06',title:'화조도',artist:'조선시대',subjects:['flowers','birds','nature'],colors:['natural harmonious colors'],mood:'harmonious',style:'flower bird',prompt:'Korean flower and bird painting style, harmonious composition, natural elegant colors, refined delicate brushwork, Korean aesthetic sensibility, traditional painting quality'},
  {id:'korean_07',title:'씨름',artist:'김홍도',subjects:['sport','wrestling','people'],colors:['natural earth tones'],mood:'lively',style:'genre painting',prompt:'Korean wrestling scene genre painting by Kim Hongdo, dynamic action of Korean traditional wrestling (Ssireum), lively crowd atmosphere, natural earth tone colors, energetic composition, Joseon Dynasty painting quality'},
