...
const koreanArtworks = [
  {id:'korean_01',title:'미인도',artist:'신윤복',subjects:['women','beauty','portraits'],colors:['soft pastels'],mood:'elegant',style:'beauty portrait',prompt:'Korean Hyewon Shin Yunbok Joseon Pungsokdo genre painting, elegant figure in hanbok preserving original subject gender and features, soft pastel colors, gentle expression on hanji, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  ...
  {id:'korean_03',title:'단오풍정',artist:'신윤복',subjects:['festival','people','celebration'],colors:['vibrant colors'],mood:'joyful',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok Joseon Pungsokdo genre painting, Dano festival with Korean figures in colorful hanbok preserving original subject gender, vibrant festive atmosphere, Korean daily life storytelling, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
