...
const koreanArtworks = [
  ...
  {id:'korean_06',title:'씨름',artist:'김홍도',subjects:['sport','wrestling','people'],colors:['natural earth tones'],mood:'lively',style:'genre painting',prompt:'Korean wrestling scene genre painting by Kim Hongdo, dynamic action of Korean traditional wrestling (Ssireum), lively crowd atmosphere, natural earth tone colors, energetic composition, Joseon Dynasty painting quality'},
  {id:'korean_07',title:'금강전도',artist:'정선',subjects:['mountains','landscape'],colors:['ink','subtle colors'],mood:'majestic',style:'true-view landscape',prompt:'Korean true-view landscape painting by Jeong Seon, majestic Geumgang mountain peaks, bold powerful brushwork, ink with subtle colors, dramatic composition, authentic Korean scenery, masterpiece quality'},
