// PicoArt v28.8 - 일본어 차단 재강화 + 한국 성별 유지
// Ultra-strong Japanese blocking + Gender preservation for Korean art
...
const chineseArtworks = [
  ...
  {id:'chinese_02',title:'궁녀도',artist:'주방',subjects:['people','women','portraits'],colors:['soft pastels','earth tones'],mood:'elegant',style:'figure painting',prompt:'Chinese gongbi court painting style, CRITICAL: if subject is male keep male features and masculine face, if subject is female keep female features, elegant graceful figures, delicate fine facial features, flowing robes, soft harmonious colors, extremely detailed brushwork, refined imperial court quality, PRESERVE ORIGINAL GENDER, ALLOWED: Chinese (漢字/汉字) text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text, PURE CHINESE NOT Japanese'},
  ...
  {id:'chinese_04_male',title:'황제 초상',artist:'명대',subjects:['men','emperor','portraits'],colors:['imperial colors','gold'],mood:'dignified',style:'male portrait',prompt:'Chinese Ming Dynasty emperor portrait, MASCULINE FEATURES ONLY, dignified Chinese male ruler in imperial attire, strong masculine face with beard, serious imperial expression, traditional Chinese male emperor portrait quality, PRESERVE MALE GENDER, ALLOWED: Chinese (漢字/汉字) text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text, PURE CHINESE NOT Japanese'},
  {id:'chinese_05_couple',title:'조상 부부도',artist:'청대',subjects:['couple','ancestral','man','woman'],colors:['formal colors','ornate'],mood:'formal',style:'couple portrait',prompt:'Chinese ancestral couple portrait, CRITICAL: if couple photo keep BOTH genders - male stays male with beard, female stays female, dignified husband and wife in formal traditional attire, seated formal pose, ornate background, PRESERVE BOTH ORIGINAL GENDERS IN COUPLE, ALLOWED: Chinese (漢字/汉字) text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text, PURE CHINESE NOT Japanese'},
  {id:'chinese_09',title:'미인도',artist:'당인',subjects:['women','portraits','beauty'],colors:['soft colors','pastels'],mood:'refined',style:'beauty portrait',prompt:'Chinese gongbi beauty portrait style, CRITICAL: maintain original subject gender, if male keep masculine features, if female keep feminine features, elegant refined figure, delicate detailed facial features, soft harmonious colors, fine silk texture rendering, graceful posture, traditional Chinese beauty painting quality, PRESERVE ORIGINAL GENDER, ALLOWED: Chinese (漢字/汉字) text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text, PURE CHINESE NOT Japanese'},
...
const koreanArtworks = [
  {id:'korean_01',title:'미인도',artist:'신윤복',subjects:['women','beauty','portraits'],colors:['soft pastels'],mood:'elegant',style:'beauty portrait',prompt:'Korean Hyewon Shin Yunbok Joseon Pungsokdo genre painting, CRITICAL: if subject is male keep male features and masculine appearance, if subject is female keep female features, elegant figure in hanbok, soft pastel colors, gentle expression on hanji, PRESERVE ORIGINAL GENDER, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  {id:'korean_02',title:'까치호랑이',artist:'민화',subjects:['tiger','magpie','animals'],colors:['bright colors','bold outlines'],mood:'cheerful',style:'folk painting',prompt:'Korean Minhwa folk painting, THICK BOLD BLACK OUTLINES, BRIGHT Obangsaek colors (red blue yellow white black), FLAT naive composition, playful tiger and magpie, UNIQUELY KOREAN style, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  {id:'korean_03',title:'단오풍정',artist:'신윤복',subjects:['festival','people','celebration'],colors:['vibrant colors'],mood:'joyful',style:'genre painting',prompt:'Korean Hyewon Shin Yunbok Joseon Pungsokdo genre painting, CRITICAL: maintain each person original gender from photo, if male keep male if female keep female, Dano festival with Korean figures in colorful hanbok, vibrant festive atmosphere, Korean daily life storytelling, PRESERVE ALL ORIGINAL GENDERS, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  {id:'korean_03_couple',title:'월하정인',artist:'신윤복',subjects:['couple','romance','man','woman'],colors:['soft colors','moonlit'],mood:'romantic',style:'couple painting',prompt:'Korean Hyewon Shin Yunbok romantic moonlight scene, CRITICAL: if couple photo keep BOTH genders - male stays male, female stays female, Korean man and woman in hanbok under moonlight, soft refined colors with ink washes, intimate romantic atmosphere, PRESERVE BOTH ORIGINAL GENDERS IN COUPLE, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  {id:'korean_04_male',title:'선비 초상',artist:'조선시대',subjects:['men','scholars','portraits'],colors:['earth tones','black ink'],mood:'dignified',style:'male portrait',prompt:'Korean Joseon Dynasty male scholar portrait, MASCULINE FEATURES ONLY, dignified Korean man in traditional scholar official attire with gat hat, strong masculine face with beard, serious scholarly expression on hanji, KOREAN MALE PORTRAIT tradition, PRESERVE MALE GENDER, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  {id:'korean_06',title:'책거리',artist:'민화',subjects:['books','stationery','still life','scholar objects'],colors:['bright colors','colorful patterns'],mood:'scholarly',style:'folk still life',prompt:'Korean Minhwa Chaekgeori folk painting, scholar objects still life, THICK BLACK OUTLINES, BRIGHT decorative colors, FLAT impossible perspective, PURELY KOREAN folk genre, ALLOWED: Hangul (한글) + Chinese (漢字) on book spines as text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  {id:'korean_07',title:'맹호도',artist:'조선시대',subjects:['tiger','fierce','animal','pine tree'],colors:['black ink','brown','aged paper'],mood:'powerful',style:'realistic animal',prompt:'Korean Joseon fierce tiger painting Maenghodo, powerful tiger under pine tree, detailed fur texture, monochrome ink with brown on aged hanji, bold Korean brushwork, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  {id:'korean_08',title:'인왕제색도',artist:'정선',subjects:['mountains','rocks','landscape'],colors:['black ink','grey'],mood:'powerful',style:'true-view landscape',prompt:'Korean Jeong Seon Jingyeong true-view landscape, bold Inwangsan rocky mountains, dramatic EXPRESSIVE Korean brushwork, monochrome ink angular forms, REAL Korean scenery, revolutionary Korean landscape tradition, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'},
  {id:'korean_09',title:'화조도',artist:'조선시대',subjects:['flowers','birds','nature'],colors:['natural harmonious colors'],mood:'harmonious',style:'flower bird',prompt:'Korean Joseon Hwajodo flower-bird painting, PRESERVE photo composition, harmonious naturalistic composition, natural elegant colors, refined brushwork on hanji, peaceful contemplative mood, KOREAN FLOWER-BIRD tradition, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタ카ナ), PURE KOREAN'},
  {id:'korean_10',title:'씨름',artist:'김홍도',subjects:['sport','wrestling','people','men'],colors:['natural earth tones'],mood:'lively',style:'genre painting',prompt:'Korean Danwon Kim Hongdo Pungsokdo genre painting, dynamic Ssireum wrestling action, lively Korean men, natural earth tones, energetic Korean folk culture composition, swift brushwork, ICONIC KOREAN GENRE PAINTING, ALLOWED: Hangul (한글) + Chinese (漢字) text only, NO Japanese kana (ひらがな/カタカナ), PURE KOREAN'}
];
...
const fallbackPrompts = {
  ...
  korean: {
    name: '한국 민화',
    prompt: 'Korean Minhwa folk painting style, bright Obangsaek colors (red blue yellow green), thick bold black outlines, flat decorative composition, Korean folk motifs (magpies/tigers/flowers), cheerful naive aesthetic, ALLOWED: Hangul + Chinese text only, NO Japanese kana, PURE KOREAN'
  },
...
- ALLOWED: Chinese characters (漢字/汉字) text only
- ABSOLUTELY FORBIDDEN: Japanese hiragana (ひらがな)
- ABSOLUTELY FORBIDDEN: Japanese katakana (カタカナ)
- ABSOLUTELY FORBIDDEN: Any Japanese text format
- This is PURE CHINESE ART, NOT Japanese art
- If ANY Japanese characters appear, the result is FAILED
...
Return ONLY valid JSON (no markdown):
{
  ...
  "prompt": "Complete FLUX prompt starting with 'Chinese [style name] style, [characteristics]... ALLOWED: Chinese (漢字/汉字) text only, ABSOLUTELY NO Japanese hiragana (ひらがな), ABSOLUTELY NO Japanese katakana (カタカナ), NO Japanese text, PURE CHINESE NOT Japanese'"
}
      ...
      'https://api.replicate.com/v1/models/black-forest-labs/flux-depth-dev/predictions',
      {
        ...
        body: JSON.stringify({
          input: {
            control_image: image,
            prompt: finalPrompt,
            num_inference_steps: 24,       // 28 → 24 (속도 최적화)
            guidance: 11,                   // 12 → 11 (품질 균형)
            output_format: 'jpg',
            output_quality: 90
          }
        })
